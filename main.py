...
try:
    ...
    def index():
        return render_template("start_page.html", year=datetime.now().year, title="Главная")
    ...
    def shops():
        ...
        if form.validate_on_submit():
            ...
            for i, t in store_dic.items():
                print(i, t)
            return render_template("list_shops.html",
                                   form=form, year=datetime.now().year, shops=store_dic,
                                   title=f"Поиск магазинов: {form.title.data}")
            # return redirect("/projects")
        return render_template("shops.html", form=form, year=datetime.now().year, title="Найти магазин")
    ...
    def projects():
        ...
        return render_template("index.html", news=news, form=form, year=datetime.now().year, title="")
    ...
    def shop(id):
        ...
        return render_template('shop.html', shop=shop_n, year=datetime.now().year, title="")
    ...
    def project(id):
        ...
        if news:
            ...
            return render_template("project.html", news=news, comments=comments, form=form, year=datetime.now().year, title="")
        return redirect("/projects")
    ...
    def reqister():
        ...
        if form.validate_on_submit():
            if form.password.data != form.password_again.data:
                return render_template('register.html', title='Регистрация', form=form,
                                       message="Пароли не совпадают", year=datetime.now().year)
            db_sess = db_session.create_session()
        ...
        return render_template('register.html', title='Регистрация', form=form, year=datetime.now().year)
    ...
    def login():
        ...
        if form.validate_on_submit():
            ...
            if user and user.check_password(form.password.data):
                ...
                return redirect("/projects")
            return render_template('login.html', message="Неправильный логин или пароль", form=form, year=datetime.now().year)
        return render_template('login.html', title='Авторизация', form=form, year=datetime.now().year)
    ...
    def components():
        ...
        return render_template("components.html", comps=comps, title='Радиокомпоненты', year=datetime.now().year)
    ...
    def add_news():
        ...
        if form.validate_on_submit():
            ...
            db_sess.commit()
            return redirect('/projects')
        return render_template('news.html', title='Добавление проекта', form=form, year=datetime.now().year)
    ...
    def error():
        return render_template('error.html',
                               title="Ошибка", message="Произошла непредвиденная ошибка"
                               )
